...
class DB_mgmt():
    ...
    def createTables():
        try:
            ...
            queryCursor.execute('CREATE TABLE permissions (user_id INTEGER, device_id INTEGER, name TEXT, FOREIGN KEY(device_id) REFERENCES switches(device_id), FOREIGN KEY(user_id) REFERENCES users(user_id), PRIMARY KEY (user_id, device_id))')
        except:
            return False
