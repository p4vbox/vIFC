...
set ylabel '{/Helvetica:Bold CCDF}'
...
plot    'ctable.csv' using 1:2 with steps title "vIFC" lw 4 lt rgb P4, \
        'ctable.csv' using 1:3 with steps title "No vIFC" lw 4 lt rgb PVS
